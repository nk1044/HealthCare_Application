        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-blue-800">Patient Instructions</h3>
                <div className="mt-2 text-sm text-blue-700">
                  <p>Please ensure you're in a quiet environment with good internet connectivity before joining the call. Have any relevant medical documents or information ready.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <form className="p-6 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <textarea
              ...
              className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 focus:outline-none p-3"
            ></textarea>
            <p className="mt-2 text-sm text-gray-500">
